...
const galleryItems = [
  ...
  { 
    id: 11, 
    src: '/images/beef_stroganoff_1778275991832.png', 
  ...
  { 
    id: 13, 
    src: '/images/trending_6_1778275788503.png', 
    alt: 'Dark Chocolate',
    category: 'Food Facts',
    date: 'Jan 20',
    title: 'Dark Chocolate',
    desc: 'Packed with antioxidants that support heart health and boost mood naturally.',
    size: 'small',
    overlay: false
  },
  { 
    ...
    desc: 'A royal dish known for aromatic spices and rich flavors loved worldwide.',
    size: 'small',
    overlay: false
  },
];
      ...
      <div className="container">
        ...
        <div className={styles.bentoGrid}>
          {galleryItems.map((item) => (
            <div 
              key={item.id} 
              className={`${styles.gridItem} ${styles[item.size]} ${item.overlay ? styles.withOverlay : ''}`}
            >
